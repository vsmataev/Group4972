...
// другой вариант
string DecToBinRec(int number) //рекуррентный метод
{
...
Console.WriteLine();
Console.WriteLine( Convert.ToString(number, 2)); //через запятую можно указать систему исчисления (встроенная функция)
