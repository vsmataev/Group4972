...
// Создание и заполенение двумерного массива (по сути - таблица)
int[,] Fill2DArray(int countRow, int countColumn, int topBorder, int downBorder)
{
    ...
    {
        for (int j = 0; j < countColumn; j++) // i использовать уже нельзя
        {
...
int[,] arr2D = Fill2DArray(row,column,100,10); //размер массива и границы значений
Print2DArray(arr2D);
